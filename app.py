...
def run_inference_on_image(image_pil, model):
    """Shared inference routine for static uploaded images."""
    ...
    try:
        while True:
            ...
            for (x, y, w, h) in faces:
                ...
                text = f"{ethnicity}, {gender}, {age} yrs"
                cv2.putText(frame, text, (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.8, ui_color, 2)
